<template>
  <div style="border: 2px solid #000000; padding: 10px; border-radius: 10px">
    ...
    <table>
      ...
      <tr>
        <th>所在地</th>
        <td>530-0001<br />大阪府大阪市北区梅田1丁目1-3 大阪駅前第3ビル 29階1-1-1号室</td>
      </tr>
      <tr>
        <th>代表社員</th>
        <td>藤本 永一</td>
    ...
    <p>
      ...
      なお、上記に該当する主な第三者企業およびそのプライバシーポリシーは以下のとおりですので、詳細につきましては、各社のウェブサイトをご確認ください。
    </p>

    <ul>
      <li>
        <a href="https://policies.google.com/privacy?hl=ja" target="_blank">グーグル合同会社 </a>
      </li>
      <li>
        <a href="https://prtimes.co.jp/policy/" target="_blank">株式会社PR TIMES</a>
      </li>
      <li>
        <a href="https://privacy.microsoft.com/ja-jp/privacystatement">Microsoft</a>
      </li>
    </ul>
